<template>
    <div :style="style" class="image-uploader">
        <label :for="name">
            <svg v-if="!src && !baseSrc" viewBox="0 0 99 80" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="tours" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="MY_TOURS-create_a_tour" transform="translate(-218.000000, -767.000000)" fill="#aaaaaa"
                        fill-rule="nonzero">
        ...
        <input ref="inputFile" :id="name" :name="name" type="file" accept="image/*" style="display:none;"
            @change="displayFile" />
